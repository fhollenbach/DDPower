...
datasets <- open_dataset("~/Documents/GitHub/SimResults_County_opioids")
...
#
cdh1 <- read_csv(here("..", "StataSim_county", "sim_CdH_county_spring24_stata1.csv"))[-1,]
cdh2 <- read_csv(here("..", "StataSim_county", "sim_CdH_county_spring24_stata2.csv"))[-1,]
cdh3 <- read_csv(here("..", "StataSim_county", "sim_CdH_county_spring24_stata3.csv"))[-1,]
cdh4 <- read_csv(here("..", "StataSim_county", "sim_CdH_county_spring24_stata4.csv"))[-1,]
...
cdh <- for_cdh %>%
  ...
  select(t, estimate, std.error, method, pct_counties_treated, no_counties_treated, true_att, true_att_deathrate, pretreatment_deathrate, sd_deathrate, notreated, pct_effect, iteration)
...
summary_by_effect_prop <- results %>%
  ...
  summarize(avg_no_treated_counties = mean(no_counties_treated),
            mean_true = mean(true_att_deathrate),
...
pl <- pl + labs(subtitle = "6 Treated States (~125 Counties)", y="Coverage", x = "") + scale_color_manual(name="Method", values = color_main) + ylim(0, 1)#+ ylim(-1, 1) #+ coord_flip()
...
pm <- pm + labs(subtitle = "12 Treated States (~249 Counties)", y="", x = "True ATE (Percent Decrease)") + scale_color_manual(name="Method", values = color_main) + ylim(0, 1) #+ coord_flip()
...
pr <- pr + labs(subtitle = "24 Treated States (~497 Counties)", y="", x = "") + scale_color_manual(name="Method", values = color_main) + ylim(0, 1)#+ ylim(-1, 1) #+ coord_flip()
...
ggsave(here("..", "output", "coverage_prop_county_opioids.pdf"), plot = p, device = cairo_pdf,  height = 10, width = 10* 1.618)
...
pl <- pl + geom_point(position = position_dodge2(width = .35), size = 3.5)
pl <- pl + theme_mfx() + theme(legend.position= 'none',legend.key=element_rect(fill='white'))
pl <- pl + labs(subtitle = "6 Treated States (~125 Counties)", y="CI Length", x = "") + scale_color_manual(name="Method", values = color_main) + ylim(0, 18)#+ ylim(-1, 1) #+ coord_flip()
pl <- pl + guides(col = guide_legend(nrow = 2))
pl
...
pm <- pm + geom_point(position = position_dodge2(width = .35), size = 3.5)
pm <- pm + theme_mfx() + theme(legend.position= 'bottom',legend.key=element_rect(fill='white'))
pm <- pm + labs(subtitle = "12 Treated States (~249 Counties)", y="", x = "True ATE (Percent Decrease)") + scale_color_manual(name="Method", values = color_main) + ylim(0, 18) #+ coord_flip()
pm <- pm + guides(col = guide_legend(nrow = 2)) +  theme(axis.ticks.y = element_blank(), axis.text.y = element_blank())
pm
...
pr <- pr + geom_point(position = position_dodge2(width = .35), size = 3.5)
pr <- pr + theme_mfx() + theme(legend.position= 'none',legend.key=element_rect(fill='white'))
pr <- pr + labs(subtitle = "24 Treated States (~497 Counties)", y="", x = "") + scale_color_manual(name="Method", values = color_main) + ylim(0, 18) #+ coord_flip()
pr <- pr + guides(col = guide_legend(nrow = 2)) +  theme(axis.ticks.y = element_blank(), axis.text.y = element_blank())
pr
...
p <- p + plot_annotation(
  ...
  theme(plot.title = element_text(size = 25, face = "bold")) &
  theme(text = element_text("IBM Plex Sans Condensed"))
ggsave(here("..", "output", "CIlength_prop_county_opioids.pdf"), plot = p, device = cairo_pdf,  height = 10, width = 10* 1.618)
...
pl <- pl + theme_mfx() + theme(legend.position= 'none',legend.key=element_rect(fill='white'))
pl <- pl + labs(subtitle = "6 Treated States (~125 Counties)", y="Power", x = "") + scale_color_manual(name="Method", values = color_main) + ylim(0, 1)#+ ylim(-1, 1) #+ coord_flip()
pl <- pl + guides(col = guide_legend(nrow = 2))
pl
...
p <- p + plot_annotation(
  ...
  theme(plot.title = element_text(size = 25, face = "bold")) &
  theme(text = element_text("IBM Plex Sans Condensed"))
ggsave(here("..", "output", "power_prop_county_opioids.pdf"), plot = p, device = cairo_pdf,  height = 10, width = 10* 1.618)

##### rmse
pl <-  ggplot(data = summary_by_effect_prop[summary_by_effect_prop$notreated == 6 , ], aes(y = rmse, x = ate, color = method))
pl <- pl + geom_point(position = position_dodge2(width = .35), size = 3.5)
pl <- pl + theme_mfx() + theme(legend.position= 'none',legend.key=element_rect(fill='white'))
pl <- pl + labs(subtitle = "6 Treated States (~125 Counties)", y="RMSE", x = "") + scale_color_manual(name="Method", values = color_main)+ ylim(0, 4)#+ ylim(-1, 1) #+ coord_flip()
pl <- pl + guides(col = guide_legend(nrow = 2))
pl
...
pm <- pm + geom_point(position = position_dodge2(width = .35), size = 3.5)
pm <- pm + theme_mfx() + theme(legend.position= 'bottom',legend.key=element_rect(fill='white'))
pm <- pm + labs(subtitle = "12 Treated States (~249 Counties)", y="", x = "True ATE (Percent Decrease)") + scale_color_manual(name="Method", values = color_main)+ ylim(0, 4) #+ coord_flip()
pm <- pm + guides(col = guide_legend(nrow = 2)) +  theme(axis.ticks.y = element_blank(), axis.text.y = element_blank())
pm
...
pr <- pr + geom_point(position = position_dodge2(width = .35), size = 3.5)
pr <- pr + theme_mfx() + theme(legend.position= 'none',legend.key=element_rect(fill='white'))
pr <- pr + labs(subtitle = "24 Treated States (~497 Counties)", y="", x = "") + scale_color_manual(name="Method", values = color_main)+ ylim(0, 4)#+ ylim(-1, 1) #+ coord_flip()
pr <- pr + guides(col = guide_legend(nrow = 2)) +  theme(axis.ticks.y = element_blank(), axis.text.y = element_blank())
pr
...
p <- p + plot_annotation(
  ...
  theme(plot.title = element_text(size = 25, face = "bold")) &
  theme(text = element_text("IBM Plex Sans Condensed"))
ggsave(here("..", "output", "rmse_prop_county_opioids.pdf"), plot = p, device = cairo_pdf,  height = 10, width = 10* 1.618)
...
pl <- pl + theme_mfx() + theme(legend.position= 'none',legend.key=element_rect(fill='white'))
pl <- pl + labs(subtitle = "6 Treated States (~125 Counties)", y="Average Error", x = "") + scale_color_manual(name="Method", values = color_main)+ ylim(-0.2, 0.4)#+ ylim(-1, 1) #+ coord_flip()
pl <- pl + guides(col = guide_legend(nrow = 2))
pl
...
pm <- pm + theme_mfx() + theme(legend.position= 'bottom',legend.key=element_rect(fill='white'))
pm <- pm + labs(subtitle = "12 Treated States (~249 Counties)", y="", x = "Mean Error") + scale_color_manual(name="Method", values = color_main)+ ylim(-0.2, 0.4) #+ coord_flip()
pm <- pm + guides(col = guide_legend(nrow = 2)) +  theme(axis.ticks.y = element_blank(), axis.text.y = element_blank())
pm
...
pr <- pr + theme_mfx() + theme(legend.position= 'none',legend.key=element_rect(fill='white'))
pr <- pr + labs(subtitle = "24 Treated States (~497 Counties)", y="", x = "") + scale_color_manual(name="Method", values = color_main)+ ylim(-0.2, 0.4)#+ ylim(-1, 1) #+ coord_flip()
pr <- pr + guides(col = guide_legend(nrow = 2)) +  theme(axis.ticks.y = element_blank(), axis.text.y = element_blank())
pr
...
p <- p + plot_annotation(
  ...
  theme(plot.title = element_text(size = 25, face = "bold")) &
  theme(text = element_text("IBM Plex Sans Condensed"))
ggsave(here("..", "output", "bias_prop_county_opioids.pdf"), plot = p, device = cairo_pdf,  height = 10, width = 10* 1.618)
...
pl <- pl + theme_mfx() + theme(legend.position= 'none',legend.key=element_rect(fill='white'))
pl <- pl + labs(subtitle = "6 Treated States (~125 Counties)", y="Exaggeration \nRatio", x = "") + scale_color_manual(name="Method", values = color_main)
...
pm <- pm + theme_mfx() + theme(legend.position= 'bottom',legend.key=element_rect(fill='white'))
pm <- pm + labs(subtitle = "12 Treated States (~249 Counties)", y="", x = "True ATE (Percent Decrease)") + scale_color_manual(name="Method", values = color_main)
...
pr <- pr + theme_mfx() + theme(legend.position= 'none',legend.key=element_rect(fill='white'))
pr <- pr + labs(subtitle = "24 Treated States (~497 Counties)", y="", x = "") + scale_color_manual(name="Method", values = color_main)
...
p <- p + plot_annotation(
  ...
  theme(plot.title = element_text(size = 25, face = "bold")) &
  theme(text = element_text("IBM Plex Sans Condensed"))
ggsave(here("..", "output", "exaggeration_prop_county_opioids.pdf"), plot = p, device = cairo_pdf,  height = 10, width = 10* 1.618)
...
pm <- pm + geom_point(position = position_dodge2(width = .5), size = 3.5)
pm <- pm + theme_mfx() + theme(legend.position= 'bottom',legend.key=element_rect(fill='white'))
pm <- pm + labs(subtitle = "12 Treated States (~249 Counties)", y="", x = "True ATE (Percent Decrease)") + scale_color_manual(name="Method", values = color_main) + ylim(0, 27) #+ coord_flip()
pm <- pm + guides(col = guide_legend(nrow = 2)) +  theme(axis.ticks.y = element_blank(), axis.text.y = element_blank())  
pm
...
pr <- pr + geom_point(position = position_dodge2(width = .5), size = 3.5)
pr <- pr + theme_mfx() + theme(legend.position= 'none',legend.key=element_rect(fill='white'))
pr <- pr + labs(subtitle = "24 Treated States (~497 Counties)", y="", x = "") + scale_color_manual(name="Method", values = color_main) + ylim(0, 27)#+ ylim(-1, 1) #+ coord_flip()
pr <- pr + guides(col = guide_legend(nrow = 2)) +  theme(axis.ticks.y = element_blank(), axis.text.y = element_blank()) 
pr
...
p <- p + plot_annotation(
  ...
  theme(plot.title = element_text(size = 25, face = "bold")) & 
  theme(text = element_text("IBM Plex Sans Condensed"))
ggsave(here("..", "output", "wrongsign_prop_county_opioids.pdf"), plot = p, device = cairo_pdf,  height = 10, width = 10* 1.618)
...
imp1 <- read_csv(here("..", "StataSim_county", "sim_imputation_county_stata1.csv"))[-1,]
imp2 <- read_csv(here("..", "StataSim_county", "sim_imputation_county_stata2.csv"))[-1,]
imp3 <- read_csv(here("..", "StataSim_county", "sim_imputation_county_stata3.csv"))[-1,]
imp4 <- read_csv(here("..", "StataSim_county", "sim_imputation_county_stata4.csv"))[-1,]
...
step1 <- read_csv(here("..", "StataSim_county", "sim_stepwise_county_stata1.csv"))[-1,]
step2 <- read_csv(here("..", "StataSim_county", "sim_stepwise_county_stata2.csv"))[-1,]
step3 <- read_csv(here("..", "StataSim_county", "sim_stepwise_county_stata3.csv"))[-1,]
step4 <- read_csv(here("..", "StataSim_county", "sim_stepwise_county_stata4.csv"))[-1,]
...
pl <- pl + geom_hline(yintercept = 0.95, color = "red", linewidth = .75, alpha = 0.85)
pl <- pl + theme_mfx() + theme(legend.position= 'none',legend.key=element_rect(fill='white'))
pl <- pl + labs(subtitle = "6 Treated States (~125 Counties)", y="Coverage", x = "") + scale_color_manual(name="Method", values = color_all) + ylim(0, 1)#+ ylim(-1, 1) #+ coord_flip()
pl <- pl + guides(col = guide_legend(nrow = 2))
pl
...
pm <- pm + geom_hline(yintercept = 0.95, color = "red", linewidth = .75, alpha = 0.75)
pm <- pm + theme_mfx() + theme(legend.position= 'bottom',legend.key=element_rect(fill='white'))
pm <- pm + labs(subtitle = "12 Treated States (~249 Counties)", y="", x = "True ATE (Percent Decrease)") + scale_color_manual(name="Method", values = color_all) + ylim(0, 1) #+ coord_flip()
pm <- pm + guides(col = guide_legend(nrow = 2)) +  theme(axis.ticks.y = element_blank(), axis.text.y = element_blank())
pm
...
pr <- pr + theme_mfx() + theme(legend.position= 'none',legend.key=element_rect(fill='white'))
pr <- pr + labs(subtitle = "24 Treated States (~497 Counties)", y="", x = "") + scale_color_manual(name="Method", values = color_all) + ylim(0, 1)#+ ylim(-1, 1) #+ coord_flip()
pr <- pr + guides(col = guide_legend(nrow = 2)) +  theme(axis.ticks.y = element_blank(), axis.text.y = element_blank())
pr
...
p <- p + plot_annotation(
  ...
  theme(plot.title = element_text(size = 25, face = "bold")) &
  theme(text = element_text("IBM Plex Sans Condensed"))
ggsave(here("..", "output", "coverage_prop_county_opioids_appAll.pdf"), plot = p, device = cairo_pdf,  height = 10, width = 10* 1.618)
...
pl <- pl + geom_point(position = position_dodge2(width = .35), size = 3.5)
pl <- pl + theme_mfx() + theme(legend.position= 'none',legend.key=element_rect(fill='white'))
pl <- pl + labs(subtitle = "6 Treated States (~125 Counties)", y="CI Length", x = "") + scale_color_manual(name="Method", values = color_all) + ylim(0, 18)#+ ylim(-1, 1) #+ coord_flip()
pl <- pl + guides(col = guide_legend(nrow = 2))
pl
...
pm <- pm + geom_point(position = position_dodge2(width = .35), size = 3.5)
pm <- pm + theme_mfx() + theme(legend.position= 'bottom',legend.key=element_rect(fill='white'))
pm <- pm + labs(subtitle = "12 Treated States (~249 Counties)", y="", x = "True ATE (Percent Decrease)") + scale_color_manual(name="Method", values = color_all) + ylim(0, 18) #+ coord_flip()
pm <- pm + guides(col = guide_legend(nrow = 2)) +  theme(axis.ticks.y = element_blank(), axis.text.y = element_blank())
pm
...
pr <- pr + geom_point(position = position_dodge2(width = .35), size = 3.5)
pr <- pr + theme_mfx() + theme(legend.position= 'none',legend.key=element_rect(fill='white'))
pr <- pr + labs(subtitle = "24 Treated States (~497 Counties)", y="", x = "") + scale_color_manual(name="Method", values = color_all) + ylim(0, 18) #+ coord_flip()
pr <- pr + guides(col = guide_legend(nrow = 2)) +  theme(axis.ticks.y = element_blank(), axis.text.y = element_blank())
pr
...
p <- p + plot_annotation(
  ...
  theme(plot.title = element_text(size = 25, face = "bold")) &
  theme(text = element_text("IBM Plex Sans Condensed"))
ggsave(here("..", "output", "CIlength_prop_county_opioids_appAll.pdf"), plot = p, device = cairo_pdf,  height = 10, width = 10* 1.618)
...
pl <- pl + geom_hline(yintercept = 0.8, color = "red", size = .75, alpha = 0.85)
pl <- pl + theme_mfx() + theme(legend.position= 'none',legend.key=element_rect(fill='white'))
pl <- pl + labs(subtitle = "6 Treated States (~125 Counties)", y="Power", x = "") + scale_color_manual(name="Method", values = color_all) + ylim(0, 1)#+ ylim(-1, 1) #+ coord_flip()
pl <- pl + guides(col = guide_legend(nrow = 2))
pl
...
p <- p + plot_annotation(
  ...
  theme(plot.title = element_text(size = 25, face = "bold")) &
  theme(text = element_text("IBM Plex Sans Condensed"))
ggsave(here("..", "output", "power_prop_county_opioids_appAll.pdf"), plot = p, device = cairo_pdf,  height = 10, width = 10* 1.618)

##### rmse
pl <-  ggplot(data = summary_by_effect_prop[summary_by_effect_prop$notreated == 6 , ], aes(y = rmse, x = ate, color = method))
pl <- pl + geom_point(position = position_dodge2(width = .35), size = 3.5)
pl <- pl + theme_mfx() + theme(legend.position= 'none',legend.key=element_rect(fill='white'))
pl <- pl + labs(subtitle = "6 Treated States (~125 Counties)", y="RMSE", x = "") + scale_color_manual(name="Method", values = color_all)+ ylim(0, 4)#+ ylim(-1, 1) #+ coord_flip()
pl <- pl + guides(col = guide_legend(nrow = 2))
pl
...
pm <- pm + geom_point(position = position_dodge2(width = .35), size = 3.5)
pm <- pm + theme_mfx() + theme(legend.position= 'bottom',legend.key=element_rect(fill='white'))
pm <- pm + labs(subtitle = "12 Treated States (~249 Counties)", y="", x = "True ATE (Percent Decrease)") + scale_color_manual(name="Method", values = color_all)+ ylim(0, 4) #+ coord_flip()
pm <- pm + guides(col = guide_legend(nrow = 2)) +  theme(axis.ticks.y = element_blank(), axis.text.y = element_blank())
pm
...
pr <- pr + geom_point(position = position_dodge2(width = .35), size = 3.5)
pr <- pr + theme_mfx() + theme(legend.position= 'none',legend.key=element_rect(fill='white'))
pr <- pr + labs(subtitle = "24 Treated States (~497 Counties)", y="", x = "") + scale_color_manual(name="Method", values = color_all)+ ylim(0, 4)#+ ylim(-1, 1) #+ coord_flip()
pr <- pr + guides(col = guide_legend(nrow = 2)) +  theme(axis.ticks.y = element_blank(), axis.text.y = element_blank())
pr
...
p <- p + plot_annotation(
  ...
  theme(plot.title = element_text(size = 25, face = "bold")) &
  theme(text = element_text("IBM Plex Sans Condensed"))
ggsave(here("..", "output", "rmse_prop_county_opioids_appAll.pdf"), plot = p, device = cairo_pdf,  height = 10, width = 10* 1.618)
...
pl <- pl + geom_hline(yintercept = 0, color = "red", size = .75, alpha = 0.75)
pl <- pl + theme_mfx() + theme(legend.position= 'none',legend.key=element_rect(fill='white'))
pl <- pl + labs(subtitle = "6 Treated States (~125 Counties)", y="Average Error", x = "") + scale_color_manual(name="Method", values = color_all)+ ylim(-2, 0.4)#+ ylim(-1, 1) #+ coord_flip()
pl <- pl + guides(col = guide_legend(nrow = 2))
pl
...
pm <- pm + geom_hline(yintercept = 0, color = "red", size = .75, alpha = 0.75)
pm <- pm + theme_mfx() + theme(legend.position= 'bottom',legend.key=element_rect(fill='white'))
pm <- pm + labs(subtitle = "12 Treated States (~249 Counties)", y="", x = "Mean Error") + scale_color_manual(name="Method", values = color_all)+ ylim(-2, 0.4) #+ coord_flip()
pm <- pm + guides(col = guide_legend(nrow = 2)) +  theme(axis.ticks.y = element_blank(), axis.text.y = element_blank())
pm
...
pr <- pr + geom_hline(yintercept = 0, color = "red", size = .75, alpha = 0.75)
pr <- pr + theme_mfx() + theme(legend.position= 'none',legend.key=element_rect(fill='white'))
pr <- pr + labs(subtitle = "24 Treated States (~497 Counties)", y="", x = "") + scale_color_manual(name="Method", values = color_all)+ ylim(-2, 0.4)#+ ylim(-1, 1) #+ coord_flip()
pr <- pr + guides(col = guide_legend(nrow = 2)) +  theme(axis.ticks.y = element_blank(), axis.text.y = element_blank())
pr
...
p <- p + plot_annotation(
  ...
  theme(plot.title = element_text(size = 25, face = "bold")) &
  theme(text = element_text("IBM Plex Sans Condensed"))
ggsave(here("..", "output", "bias_prop_county_opioids_appAll.pdf"), plot = p, device = cairo_pdf,  height = 10, width = 10* 1.618)
...
pl <- pl + guides(col = guide_legend(nrow = 2)) + scale_y_continuous(limits = c(0.9, 7))
pl
...
pm <- pm + geom_hline(yintercept = 1, color = "red", size = .75, alpha = 0.5)
pm <- pm + theme_mfx() + theme(legend.position= 'bottom',legend.key=element_rect(fill='white'))
pm <- pm + labs(subtitle = "12 Treated States (~249 Counties)", y="", x = "True ATE (Percent Decrease)") + scale_color_manual(name="Method", values = color_all)
pm <- pm + guides(col = guide_legend(nrow = 2)) +  theme(axis.ticks.y = element_blank(), axis.text.y = element_blank()) +scale_y_continuous(limits = c(0.9, 7))
pm
...
pr <- pr + geom_hline(yintercept = 1, color = "red", size = .75, alpha = 0.5)
pr <- pr + theme_mfx() + theme(legend.position= 'none',legend.key=element_rect(fill='white'))
pr <- pr + labs(subtitle = "24 Treated States (~497 Counties)", y="", x = "") + scale_color_manual(name="Method", values = color_all)
pr <- pr + guides(col = guide_legend(nrow = 2)) +  theme(axis.ticks.y = element_blank(), axis.text.y = element_blank()) + scale_y_continuous(limits = c(0.9, 7))
pr
...
p <- p + plot_annotation(
  ...
  theme(plot.title = element_text(size = 25, face = "bold")) &
  theme(text = element_text("IBM Plex Sans Condensed"))
ggsave(here("..", "output", "exaggeration_prop_county_opioids_appAll.pdf"), plot = p, device = cairo_pdf,  height = 10, width = 10* 1.618)
...
pm <- pm + geom_point(position = position_dodge2(width = .5), size = 3.5)
pm <- pm + theme_mfx() + theme(legend.position= 'bottom',legend.key=element_rect(fill='white'))
pm <- pm + labs(subtitle = "12 Treated States (~249 Counties)", y="", x = "True ATE (Percent Decrease)") + scale_color_manual(name="Method", values = color_all) + ylim(0, 27) #+ coord_flip()
pm <- pm + guides(col = guide_legend(nrow = 2)) +  theme(axis.ticks.y = element_blank(), axis.text.y = element_blank())  
pm
...
pr <- pr + geom_point(position = position_dodge2(width = .5), size = 3.5)
pr <- pr + theme_mfx() + theme(legend.position= 'none',legend.key=element_rect(fill='white'))
pr <- pr + labs(subtitle = "24 Treated States (~497 Counties)", y="", x = "") + scale_color_manual(name="Method", values = color_all) + ylim(0, 27)#+ ylim(-1, 1) #+ coord_flip()
pr <- pr + guides(col = guide_legend(nrow = 2)) +  theme(axis.ticks.y = element_blank(), axis.text.y = element_blank()) 
pr
...
p <- p + plot_annotation(
  ...
  theme(plot.title = element_text(size = 25, face = "bold")) & 
  theme(text = element_text("IBM Plex Sans Condensed"))
ggsave(here("..", "output", "wrongsign_prop_county_opioids_appAll.pdf"), plot = p, device = cairo_pdf,  height = 10, width = 10* 1.618)
